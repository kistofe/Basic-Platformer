...
bool j1App::Awake()
{
	...
	save_game.create("save.xml");
	load_game.create("save.xml");
	...
	if(config.empty() == false)
	{
		...
		frame_cap = app_config.child("framerate").attribute("framerate_cap").as_uint(0);
	}
...
void j1App::FinishUpdate()
{
	...
	if (ptimer.ReadMs() < 1000 / frame_cap)
	{
		uint32 delay_value = 1000 / frame_cap - ptimer.ReadMs();
